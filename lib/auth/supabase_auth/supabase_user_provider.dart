...
class CompleteOSV1SupabaseUser extends BaseAuthUser {
  CompleteOSV1SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> completeOSV1SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CompleteOSV1SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
