...
import 'signup_content_model.dart';
export 'signup_content_model.dart';
...
class _SignupContentWidgetState extends State<SignupContentWidget> {
  late SignupContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupContentModel());
