...
import 'task_type_section_model.dart';
...
class _TaskTypeSectionWidgetState extends State<TaskTypeSectionWidget> {
  late TaskTypeSectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskTypeSectionModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      visible: (FFAppState().activeSystemTab == 'task') &&
